...
At the moment, only QMK is supported. ZMK in wired mode is also possible, but it has not been implemented yet.

## Credits

Special thanks to [Cipulot](https://github.com/Cipulot/) for all the work on EC keyboards and assistance.

- Outline by [jimmerricks (Swoop)](https://github.com/jimmerricks/swoop)
- Inspired to use this ouline by [duckyb](https://github.com/duckyb/urchin)
